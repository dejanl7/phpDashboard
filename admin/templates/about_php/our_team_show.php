		...
		<div class="box row" id="our_team_container">
				...
				<h2 id="headline2" class="intro-text text-center">
					<div id="our_team_headline_container" style="
						font-size: <?php echo about_us::css("about_us","our_team_headline_fontweight"); ?>;	
						font-family: <?php echo about_us::css("about_us","our_team_headline_fonttype"); ?>;
					">
...
<!-- INFORMATION are related with "NAŠ TIM" div -->
			<div id="our_team_container_for_font_color">
				<div class="text-justify" id="our_team_edit" style="
					font-size:<?php echo about_us::css('about_us','our_team_div_font_weight'); ?>; 
					font-family:<?php echo about_us::css('about_us','our_team_div_font_type'); ?>;
				">
				<?php
					$show = "SELECT * FROM about_us WHERE user_id = ". $base->clear_string($session->user_id_session);
				...
				<?php
					foreach($show_all as $show_me){
						if($show_me->our_team_show_picture == "1"){
							...
							$cleaned_user_id = $base->clear_string($session->user_id_session);
...
<!-- CONDITION FOR SHOWING IMAGES. If worker biography document is not empty, we can see that biography on mouse click.--> 				
				...
				?>
					<strong><a href="<?php echo $biography_img->worker_files_path(); ?>"><p><?php echo $biography_img->worker_name; ?></a></p></strong>				
					<img class="thumbnail biog_img" id="<?php echo $biography_img->biography_id; ?>" width="185px" height="180px" src="<?php echo $biography_img->worker_image_path(); ?>" data = "<?php echo $biography_img->biography_id; ?>" data1 = "<?php echo $biography_img->biography_id; ?>" alt="" />
...
<!-- IN OTHER CASE, We can see name of worker without biography...-->					
				<?php } else{ ?>
					...
					<img class="thumbnail biog_img" width="200px" height="180px" src="<?php echo $biography_img->worker_image_path(); ?>" data = "<?php echo $biography_img->biography_id; ?>" data1 = "<?php echo $biography_img->biography_id; ?>" alt="" />
				<?php } ?>
				</div>
					<?php endforeach; ?>
			</div>
